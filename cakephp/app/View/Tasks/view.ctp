...
<ul>	
    <li>ユーザー: <?php echo $task['User']['username']; ?></li>
    <li>カテゴリー: <?php echo $task['Category']['name']; ?></li>
    <li>締切日付: <?php echo $tmp_deadline_date; ?></li>
    <li>締切時間: <?php echo $tmp_deadline_time; ?></li>
    <li>作成日時: <?php echo $tmp_created; ?></li>
    <li>更新日時: <?php echo $tmp_modified; ?></li>
    <li>
